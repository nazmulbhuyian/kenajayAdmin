...
const SuccessWithdrawalDescription = ({ setDesCription, desCriptionDATA }) => {
    console.log(desCriptionDATA);
     
   return  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 p-6">
         <div className="relative overflow-hidden text-left bg-white rounded-lg shadow-xl w-[750px] p-6 max-h-[90vh] overflow-y-auto scrollbar-thin">
           <div>
             <h3
               ...
               id="modal-title "
             >
               Success Withdrawal Description
             </h3>
             <button
               type="button"
...
export default SuccessWithdrawalDescription